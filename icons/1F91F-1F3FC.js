...
const LoveYouGesture_MediumLightSkinTone = ({
  size,
  outline
}) => {
  if (!size) size = '1.7em';
  ...
  if (!outline) {
    return /*#__PURE__*/React.createElement("svg", {
      ...
      strokeLinejoin: "round",
      strokeWidth: "2",
      d: "M30.0394,27.604 c0.2371-2.1519,1.7598-3.4091,3.8076-3.4552c1.9138-0.043,3.9409,0.9576,3.9591,3.2774c0,0,0.1972,6.9598,0.1592,7.3048 c-0.2371,2.1519-2.1736,3.7041-4.3255,3.467c-2.1518-0.237-3.3818-2.198-3.467-4.3254L30.0394,27.604z"
    }), /*#__PURE__*/React.createElement("path", {
      fill: "none",
      stroke: "#000000",
      strokeLinecap: "round",
      strokeLinejoin: "round",
      strokeWidth: "2",
      d: "M22.1086,27.604 c0.2371-2.1519,1.7598-3.4091,3.8076-3.4552c1.9138-0.043,3.9409,0.9576,3.9591,3.2774c0,0,0.1972,6.9598,0.1592,7.3048 c-0.2371,2.1519-2.1736,3.7041-4.3255,3.467c-2.1518-0.237-3.3818-2.198-3.467-4.3254L22.1086,27.604z"
    })));
  } else {
    return /*#__PURE__*/React.createElement("svg", {
      width: size,
...
export default LoveYouGesture_MediumLightSkinTone;